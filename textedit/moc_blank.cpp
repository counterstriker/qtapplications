...
**
** Created: Thu Nov 21 20:38:57 2013
...
static const char qt_meta_stringdata_Blank[] = {
    "Blank\0\0e\0clicked(QMouseEvent*)\0"
    "onSelect(QMouseEvent*)\0"
};
...
void Blank::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSelect((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Blank::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Blank::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Blank,
      qt_meta_data_Blank, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Blank::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Blank))
...
// SIGNAL 0
void Blank::clicked(QMouseEvent * _t1)
{
